...
const solutions = [
  ...
  },
  {
    ...
    body:
      'En un clic, Reval genera un reporte profesional con gráficos, precio estimado y análisis de mercado. Diseñado para que el propietario diga que sí.',
  },
]
...
export default function Solution() {
  return (
    <section className="py-28 px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#0B0B0C] via-[#0d0d14] to-[#0B0B0C] pointer-events-none" />
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          <p className="text-sm font-semibold text-blue-400 tracking-widest uppercase mb-4">La solución</p>
        ...
        >
          {solutions.map(({ icon, label, title, body }, index) => (
            <motion.div
              ...
              className="relative rounded-2xl border border-white/[0.07] bg-[#111115] p-7 group overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-40 h-40 bg-blue-600/5 rounded-full blur-3xl group-hover:bg-blue-600/10 transition-all duration-500 translate-x-1/2 -translate-y-1/2" />

              <div className="relative">
                <div className="inline-flex items-center justify-center w-11 h-11 rounded-xl bg-gradient-to-br from-blue-600/20 to-violet-600/20 text-blue-400 mb-5 border border-blue-500/20">
                  {icon}
                </div>
                <span className="block text-xs font-semibold text-blue-400/60 tracking-widest uppercase mb-2">
                  {label}
                </span>
