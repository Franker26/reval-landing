  ...
  return (
    <section className="py-28 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-sm font-semibold text-blue-600 tracking-widest uppercase mb-4">Por qué Reval</p>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
            Lo que cambia cuando
            <br />
            <span className="text-gray-400">usás Reval</span>
          </h2>
          <p className="text-gray-500 text-lg max-w-lg mx-auto">
            No vendemos software. Vendemos tiempo valioso para destinar en la captación de nuevos clientes.
          </p>
        </motion.div>
        ...
        >
          {benefits.map(({ icon, bgColor, iconColor, borderColor, metric, metricLabel, title, body }) => (
            <motion.div
              key={title}
              variants={item}
            ...
            >
              <div className="relative flex gap-5">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl ${bgColor} ${iconColor} flex-shrink-0 border ${borderColor}`}>
                  {icon}
                </div>
