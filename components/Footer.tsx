...
const links = {
  Producto: ['Cómo funciona', 'Precios', 'Simulador', 'Changelog'],
  Empresa: ['Sobre Reval', 'Blog', 'Prensa', 'Contacto'],
  Legal: ['Términos de uso', 'Privacidad', 'Cookies'],
}

export default function Footer() {
  return (
    <footer className="bg-[#0B0B0C] border-t border-white/[0.06]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              {/* LinkedIn */}
              <a href="#" className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.07] flex items-center justify-center text-zinc-500 hover:text-zinc-300 hover:bg-white/[0.08] transition-all">
          ...
          {Object.entries(links).map(([category, items]) => (
            <div key={category}>
              <p className="text-zinc-300 text-xs font-semibold tracking-widest uppercase mb-4">{category}</p>
