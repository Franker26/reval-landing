...
const roadmapItems = [
  {
    status: 'Próximamente',
    statusColor: 'text-blue-400 bg-blue-500/15 border-blue-500/25',
    icon: (
  ...
  },
  {
    ...
    statusColor: 'text-violet-400 bg-violet-500/15 border-violet-500/25',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    status: 'En roadmap',
    statusColor: 'text-zinc-400 bg-zinc-500/15 border-zinc-500/25',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    <section className="py-28 px-6 bg-[#0B0B0C]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-sm font-semibold text-blue-400 tracking-widest uppercase mb-4">Visión</p>
        ...
        <div className="relative">
          ...
          <div className="absolute left-[27px] top-8 bottom-8 w-px bg-gradient-to-b from-blue-500/40 via-violet-500/20 to-transparent hidden md:block" />

          <div className="space-y-5">
            {roadmapItems.map(({ status, statusColor, icon, title, body, eta }, i) => (
              <motion.div
                key={title}
              ...
              >
                ...
                {/* Card */}
                <div className="flex-1 rounded-2xl border border-white/[0.07] bg-[#111115] p-6 group-hover:border-white/[0.12] transition-colors">
                  <div className="flex items-start justify-between flex-wrap gap-3 mb-3">
                    <div className="flex items-center gap-3">
                      <div className="md:hidden w-8 h-8 rounded-xl flex items-center justify-center bg-white/[0.04] text-zinc-400">
                        {icon}
                      </div>
                    ...
                    <span className="text-zinc-600 text-xs font-mono">{eta}</span>
                  </div>
